...
async function newProject(name) {
    return await crossCutting.updateRecord("cProject", {name: name, created: new Date()});
}

async function get_cProject() {
    let logStatus = await crossCutting.getRecord("cProject");
    return logStatus[0];
}
//===================================================================================

async function newParticipant() {
    await crossCutting.updateRecord("nParticipant", 1);
}

async function participantReaded() {
    await crossCutting.updateRecord("nParticipant", 0);
}

async function participantStatusLog() {
    let logStatus = await crossCutting.getRecord("nParticipant");
    return parseInt(logStatus[0]);
}
...
module.exports.get_cProject = get_cProject;
module.exports.newParticipant = newParticipant;
module.exports.participantReaded = participantReaded;
module.exports.participantStatusLog = participantStatusLog;